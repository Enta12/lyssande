    ...
    return (
        <>
            <div className="flex flex-col pb-5 w-full">
                ...
                <div className="bg-darkBrown w-full h-2 rounded-lg"/>
            </div>
...
const MapSelector = ({name, actif, index, handleChange, last}: {last: boolean, handleChange: (index: number) => void, name: string, actif: boolean, index:number}) => {
    return(
        <div className="bg-darkBrown rounded-t-full flex">
            <div className={`bg-amber-100 ${actif && "rounded-br-full"} w-2 h-full self-end`} />
            <div 
            ...
            <div className={`bg-amber-100 ${actif && "rounded-bl-ful"}l w-2 h-full self-end`} />
        </div>
